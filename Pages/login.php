...
<div><img class="mb-4" src="../images/ch.png"  width="200" height="200" ;>
    <h1   >Veuillez vous connecter</h1></div>
    ...
    <div class="form-floating height: auto;">
      ...
      <a  style="text-decoration:none;" href="initialiserPwd.php"> <h5><span style="color:black"><br>mot de passe oublier?<br></span></h5></a>
      </div>
    <p class="text-right">
...
<button class="w-100 btn btn-lg btn-success"type="submit">Se connecter</button>
    ...
    <p class="text-right">
                     ...
                     <h5> <span class="bi bi-plus-lg" style="color:black"> Créer un compte</span></h5>
                      </div>
                      </a>
